...
function CreateDestination() {
    ...
    const handleSave = async(e) => {
        e.preventDefault()
        setTime(Date.now())
        const result = await axios.post('/api/admin/create-destination', {destinationName,description,location, image, time },
            {
    ...
    return (
        <div className='pt-20 p-6 lg:h-screen'>
            <div>
                <h2 className='text-2xl lg:text-3xl font-semibold'>Create Destination</h2>
            </div>
