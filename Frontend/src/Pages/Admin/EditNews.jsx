...
function EditNews() {
    ...
    useEffect(() => {
        axios.get(`/api/admin/get-news-data/${newsId}`).then((response)=>{
    ...
    const handleSave = (e) => {
        e.preventDefault()
        axios.put(`/api/admin/update-news/${newsId}`,{newsHeading,description,time}).then((response)=>{
    ...
    return (
        <div className='pt-20 p-6 lg:h-screen'>
            <div>
                <h2 className='text-2xl lg:text-3xl font-semibold'>Edit News</h2>
            </div>
